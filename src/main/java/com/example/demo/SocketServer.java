...
//                        boolean b=userDaoImp.Findusername(str);
//                        if(b){
//                            //更新
//                            userDaoImp.update("23.38640","113.30155",str);
//                            System.out.println("更新成功");
//                        }
//                        else{
//                            //创建插入数据
//                            userDaoImp.create("23.38640","113.30150",str);
...
//                }
                ...
                if(bytes[6] == 49 && bytes[7] == 48){
                    ...
                    //进行Gps数据解析
                    L[0]=GpsServer.GpsLocation(GpsServer.gpsLatAddress(bytes));
                    L[1]=GpsServer.GpsLocation(GpsServer.gpsLonAddress(bytes));
